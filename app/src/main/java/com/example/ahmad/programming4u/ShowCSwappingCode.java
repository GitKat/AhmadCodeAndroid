...
public class ShowCSwappingCode extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(intValue){
            case 0:
                String formattedText = getString(R.string.swapTwoNumberswithoutthird);
                Spanned result = Html.fromHtml(formattedText);
                view.setText(result);
                break;

            case 1:
                String formattedText1 = getString(R.string.swapingOfStrings);
                Spanned result1 = Html.fromHtml(formattedText1);
                view.setText(result1);
                break;

            case 2:
                String formattedText2 = getString(R.string.swappingOfTwoArrays);
