...
public class ShowCLcmCode extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(intValue){
            case 0:
                String formattedText = getString(R.string.lcm);
                Spanned result = Html.fromHtml(formattedText);
                view.setText(result);
                break;

            case 1:
                String formattedText1 = getString(R.string.gcd);
                Spanned result1 = Html.fromHtml(formattedText1);
                view.setText(result1);
                break;

            case 2:
                String formattedText2 = getString(R.string.hcf);
